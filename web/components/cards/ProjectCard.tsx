    ...
    <div className='flex items-stretch dark:bg-gradient-custom-gray bg-gradient-custom-gray-dark p-[2px] rounded-xl'>
      ...
      >
          <div className='w-[420px] h-[230px] relative'>
            <div className='absolute flex badge bg-amber-200 border border-2 border-amber-800 border-solid bg-opacity-80 text-amber-800 text-sm font-semibold gap-2 p-3 bottom-2 left-2'>{remainingTimeBadge}</div>
