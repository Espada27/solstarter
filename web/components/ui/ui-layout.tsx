...
export function UiLayout({
  ...
  return (
    <div className="min-h-screen w-full flex flex-col text-textColor-main dark:text-textColor-main-dark">
      ...
      <div className="mx-4 my-24 flex-grow">
        <Suspense
          fallback={
      ...
      <footer className="bottom-0 footer footer-center p-4 bg-base-300 text-base-content mt-auto">
        <aside>
          <p>
            Generated by the{' '}
            <a
              className="link hover:text-white"
              href="https://github.com/Espada27/solstarter"
              target="_blank"
